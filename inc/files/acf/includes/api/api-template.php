...
*  get_row_sub_field
*
*  This function is used estudio86 a 'has_sub_field' while loop to return a sub field object
*
*  @type	function
*  @date	16/05/2016
*  @since	5.3.8
...
*  get_row_sub_value
*
*  This function is used estudio86 a 'has_sub_field' while loop to return a sub field value
*
*  @type	function
*  @date	16/05/2016
*  @since	5.3.8
...
*  has_sub_field()
*
*  This function is used estudio86 a while loop to return either true or false (loop again or stop).
